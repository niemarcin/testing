...
const laneStringAndSequenceCompletenessFlag testingValuesCompleteness = {
    {"Andrzej:7/|9-|X|-8|8/|-6|X|X|X||81", true},
...
INSTANTIATE_TEST_SUITE_P(SequenceCompletenessTestGroup, SequenceCompletenessSuite, testing::ValuesIn(testingValuesCompleteness));
